...
const Footer = () => (
  <div className={styles.footerStyle} style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gridGap: 590 }}>
  <div><h6>Proudly Serving the GTA </h6></div>
  <div><h6>All Custom Sheet Metal</h6></div>
